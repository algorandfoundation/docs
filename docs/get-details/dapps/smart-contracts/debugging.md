...
=== "JavaScript"
	...
	```
	[Snippet Source](https://github.com/algorand/js-algorand-sdk/blob/examples/examples/atc.ts#L73-L94)
    <!-- ===JSSDK_DEBUG_DRYRUN_DUMP=== -->
...
=== "JavaScript"
	...
	```
	[Snippet Source](https://github.com/algorand/js-algorand-sdk/blob/examples/examples/atc.ts#L97-L105)
    <!-- ===JSSDK_DEBUG_DRYRUN_SUBMIT=== -->
