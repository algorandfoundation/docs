...
3. Opcode availability. For example, all stateful operations are only available in stateful mode. Refer to [opcodes document](/get-details/dapps/avm/teal/opcodes) for details.
...
This summary is supplemented by more detail in the [opcodes document](/get-details/dapps/avm/teal/opcodes).
...
Additional details in the [opcodes document](/get-details/dapps/avm/teal/opcodes#txn) on the `txn` op.
