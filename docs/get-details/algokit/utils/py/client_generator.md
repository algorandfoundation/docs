...
There are a range of [examples](https://github.com/algorandfoundation/algokit-client-generator-py/tree/main/examples) that you can look at to see a source smart contract (`{contract.py}`), 
