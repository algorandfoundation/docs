...
To create an app you can call [`algokit.createApp(createPayload, algod)`](../code/modules/index.md#createapp). See the tests for an [example](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/app.spec.ts).
