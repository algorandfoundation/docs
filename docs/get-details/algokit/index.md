...
The [AlgoKit Quick Start](./tutorials/intro.md) guides you through installation, including a video walkthrough.

## AlgoKit CLI commands

For details on how to use individual features see the following

- [Bootstrap](./cli/bootstrap.md) - Bootstrap AlgoKit project dependencies
- [Completions](./cli/completions.md) - Install shell completions for AlgoKit
- [Doctor](./cli/doctor.md) - Check AlgoKit installation and dependencies
- [Explore](./cli/explore.md) - Explore Algorand Blockchains using Dappflow
- [Generate](./cli/generate.md) - Generate code for an Algorand project
- [Goal](./cli/goal.md) - Run the Algorand goal CLI against the AlgoKit Sandbox
- [Init](./cli/init.md) - Quickly initialize new projects using official Algorand Templates or community provided templates.
- [LocalNet](./cli/localnet.md) - Manage a locally sandboxed private Algorand network.
