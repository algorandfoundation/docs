...
**Description**
Given TEAL source code in plain text, return base64 encoded program bytes and base32 SHA512_256 hash of program bytes prepended by "Program" (Address style). This endpoint is only enabled when a node's configuration file sets EnableDeveloperAPI to true.
...
|Name|Description|Schema|
|---|---|---|
|**hash**  <br>*required*|base32 SHA512_256 of program bytes prepended by "Program" (Address style)|string|
