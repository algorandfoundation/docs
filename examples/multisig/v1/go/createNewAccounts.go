...
func main() {
	...
	act, err := algodClient.AccountInformation(account1.Address.String())
	if err != nil {
	...
	fmt.Print("Account 1: ")
	PrettyPrint(act)
	act, err = algodClient.AccountInformation(account2.Address.String())
	if err != nil {
		fmt.Printf("failed to get account information: %s\n", err)
		return
	}
	fmt.Print("Account 2: ")
	PrettyPrint(act)
	act, err = algodClient.AccountInformation(account3.Address.String())
	if err != nil {
		fmt.Printf("failed to get account information: %s\n", err)
		return
	}
